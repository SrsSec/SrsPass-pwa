...
<div id="setup-radio-group">
  ...
  <input type="radio" id="radio2" bind:group={setupOption} value={'quick'}><label for="radio2" title="Minimal setup prompts to get new users on SrsPass.">Quick Setup</label>
  <input type="radio" id="radio3" bind:group={setupOption} value={'existing'}><label for="radio3" title="For existing users that have a backup phrase to import. &#013;Backup phrases are crypto BIP39 12/18/24 mnemonics, new users with crypto wallets can use this step.">Existing User</label>
</div>
